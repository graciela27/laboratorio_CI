...
def test_monto_inicial_billetera(empty_wallet):
...
def test_cash_raises_exception_on_insufficient_amount(empty_wallet):
...
def test_transactions_insuficient_amont(empty_wallet, earned, spent):
    empty_wallet.add_cash(earned)
